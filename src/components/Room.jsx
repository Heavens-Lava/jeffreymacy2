...
const HTMLContent = ({ textPosition }) => {
  ...
  return (
    ...
    <>
      <Html>
        <div className="toggle-bar fixed flex flex-row justify-center items-center -top-[450px] -right-[650px] z-50">
      ...
      <StickyBox offsetBottom={0} offsetTop={0} bottom={false}>
        <div className="w-full h-screen absolute">
          ...
          >
            ...
            <HTMLContent textPosition={textPosition} />
